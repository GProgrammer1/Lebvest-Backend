...
public interface InvestorRepository extends JpaRepository<Investor, Long> {
        ...
        Page<Investor> findByKycStatus(com.lebvest.model.enums.VerificationStatus status, Pageable pageable);
        ...
        @EntityGraph(attributePaths = {
                        ...
                        // Note: investments and goals are fetched lazily to avoid
